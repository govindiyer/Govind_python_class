...
2. What does the list method `pop()` do?
   ...
   b) Removes and returns the last element                         a
...
4. What does the `remove()` method do in a list?
   a) Removes the element at a specific index                            a
...
15. What does the `update()` method do in a dictionary?
    a) Merges another dictionary or key-value pairs       a
...
24. What does the `copy()` method do in a list?
    a) Clears the list
    b) Returns a shallow copy of the list     a
    c) Reverses the list
    d) Sorts the list
...
27. What does the `insert()` method do in a list?
    ...
    b) Adds an element at a specific index      a
...
29. What does the `copy()` method do in a set?
    a) Clears the set
    b) Returns a shallow copy of the set    a
    c) Adds an element
...
31. What does the `symmetric_difference()` method return in a set?
    a) Elements common to both sets       a
...
33. What does the `isdisjoint()` method check in a set?
    ...
    c) If two sets have no common elements         a
    d) If a set is empty
...
35. What does the `popitem()` method do in a dictionary?
    a) Removes and returns an arbitrary key-value pair           a
...
37. What does the `setdefault()` method do in a dictionary?
    a) Sets a default key-value pair if the key doesn’t exist                a
...
44. What does the `issuperset()` method check in a set?
    ...
    d) If a set has unique elements          a
...
46. What does the `difference_update()` method do in a set?
    ...
    b) Removes elements present in another set               a
    c) Combines two sets
    d) Clears the set
...
48. What happens when you use `del dict[key]` on a dictionary?
    a) Removes the key-value pair               a
    b) Clears the dictionary         
    c) Adds a key
...
50. What does the `intersection_update()` method do in a set?
    a) Keeps only elements common to both sets                  a
